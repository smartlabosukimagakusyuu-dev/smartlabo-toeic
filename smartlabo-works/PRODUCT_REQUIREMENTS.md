...
## 0.1 CEO決定事項の反映（2026-07-10）

`PRODUCT_BOUNDARY.md`の作成過程でCEOへ確認を仰いだ結果、以下が正式決定した。本書はこの前提に統一する。
...
| 「Smart Labo Group」「Smart Labo AI」「Smart Labo CRM」 | 正式名称・正式製品ではなく、将来のブランド構想／商品候補（詳細は`PRODUCT_BOUNDARY.md`第4章） |
